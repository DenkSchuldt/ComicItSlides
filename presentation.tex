...
\usebackgroundtemplate{\includegraphics[width= \paperwidth, height=\paperheight]{fondoaz.jpg}}
	...
	\begin{frame}
		\frametitle{
			...
			\endgroup
	 		\begingroup
				...
				\normalsize
				\pause
					\color{blue}Sé dueño de tu Comic!
					\pause
				\end{center}
			\endgroup
		}
		\begin{center}
			\begin{itemize}
				\vspace{-1.5cm}
				\item\textbf{FIRMA DE AUTOR}
				\newline
				Ponle tu nombre a la historieta y así quedaras registrado como  
				\newline
				 su legítimo autor.
			\end{itemize}
		\end{center}
		\begin{center} 
			\includegraphics[width=0.75\textwidth]{firmas1.jpg}
		\end{center}
	\end{frame}
	\begin{frame}
		\frametitle{
