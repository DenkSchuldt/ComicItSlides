...
\title{Lenguajes de Programación}    % Enter your title between curly braces
\author{Ana Arias\\Liliana Ramos\\Denny Schuldt}                 % Enter your name between curly braces
\institute{ESPOL}      % Enter your institute name between curly braces
